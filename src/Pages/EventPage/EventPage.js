...
function EventPage(props) {
    ...
    return (
        <div className="EventPage">
            ...
            <BigAd image={event.image || '../../../tempImg.jpg'} title={event.name} minorTitle={event.organization} subTitle={`${event.city}, ${event.country}`} />

            <MainInfoBar priceRange={event.priceRange} dates={event.dateRange} handleBuyTickets={handleBuyTickets}/>
